...
export const generateCartItemsFrom = (cartData, productsData) => {
  ...
  const nextCart = cartData.map((cartItem) => ({
    ...cartItem,
...
export const getTotalItems = (items = []) => {
  ...
  // Calculate the total quantity by summing up the qty of each item
...
const ItemQuantity = ({
  ...
  return (
    <Stack direction="row" alignItems="center">
      <IconButton size="small" color="primary" onClick={handleDelete} disabled={value <= 0}>
        <RemoveOutlined />
      </IconButton>
